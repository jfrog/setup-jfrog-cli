...
exports.getAccessTokenFromCliOutput = getAccessTokenFromCliOutput;
...
class Utils {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!oidcProviderName && !!oidcTokenId) {
                ...
                if (accessToken == '' || accessToken == undefined) {
                    accessToken = yield this.exchangeOIDCTokenAndExportStepOutputs(oidcProviderName, oidcTokenId, url, oidcAudience);
                }
            }
     ...
     * @private
     */
    static exchangeOIDCTokenAndExportStepOutputs(oidcProviderName, oidcTokenId, url, oidcAudience) {
        return __awaiter(this, void 0, void 0, function* () {
            let output;
            try {
                output = yield (0, exec_1.getExecOutput)('jf', ['eot', oidcProviderName, oidcTokenId, '--url', url, '--oidc-audience', oidcAudience], {
                    silent: true,
            ...
            const { accessToken, username } = getAccessTokenFromCliOutput(output.stdout);
...
function getAccessTokenFromCliOutput(input) {
    if (input === '') {
