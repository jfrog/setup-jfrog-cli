...
class Utils {
    ...
    static getJfrogAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield this.getAccessTokenFromJWT(jsonWebToken);
            }
            catch (error) {
     ...
     * @private
     */
    static getAccessTokenFromJWT(jsonWebToken) {
        return __awaiter(this, void 0, void 0, function* () {
            //TODO handle with process.env.JF_URL that is ending with /
            ...
            const audience = core.getInput(Utils.OIDC_AUDIENCE_ARG, { required: false });
            const response = yield fetch(exchangeUrl, {
                method: 'POST',
                headers: {
