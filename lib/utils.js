...
class Utils {
    ...
    static getServerTokens() {
        ...
        if (legacyServerTokens.size > 0) {
            core.warning('Using "JF_ARTIFACTORY_" prefix environment variable for Artifactory server configuration is ' +
    ...
    static configArtifactoryServers() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static removeArtifactoryServers() {
        return __awaiter(this, void 0, void 0, function* () {
