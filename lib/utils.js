    ...
    static constructJobSummary() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const markdownFile of Utils.JOB_SUMMARY_MARKDOWN_FILE_NAMES) {
                try {
                    const content = yield fs_1.promises.readFile(path.join(homedir, markdownFile, 'markdown.md'), 'utf-8');
                    if (content.trim() !== '') {
...
Utils.JOB_SUMMARY_MARKDOWN_FILE_NAMES = ['upload', 'build-publish', 'security'];
// Inputs
// Version input
