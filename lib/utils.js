...
class Utils {
    ...
    static getAndAddCliToPath(jfrogCredentials) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (version == Utils.LATEST_RELEASE_VERSION) {
                version = yield Utils.getActualVersion(downloadDir, jfrogFileName);
            }
    ...
    static getActualVersion(downloadDir, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const jfrogCliPath = (0, path_1.join)(downloadDir, fileName);
                (0, fs_1.chmodSync)(jfrogCliPath, 0o555);
                let output = yield (0, exec_1.getExecOutput)(jfrogCliPath, [`--version`]);
