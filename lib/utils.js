...
class Utils {
    ...
    static generateJobSummary() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let sourceFilePath = Utils.getHomeDirByOs();
    ...
    static getHomeDirByOs() {
        switch (process.env.RUNNER_OS) {
            case "Windows":
                return (0, path_1.join)(process.env.USERPROFILE || '', ".jfrog", "jfrog-github-summary.md");
            case "Linux":
            case "macOS":
                return (0, path_1.join)(process.env.HOME || '', ".jfrog", "jfrog-github-summary.md");
            default:
                return "";
        }
    }
