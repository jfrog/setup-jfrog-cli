...
class Utils {
     ...
     */
    static runCliAndGetOutput(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const workingDirectory = process.env.GITHUB_WORKSPACE;
            if (!workingDirectory) {
                throw new Error('GITHUB_WORKSPACE is not defined.');
            }
            let output = yield (0, exec_1.getExecOutput)('jf', args, { silent: true, cwd: workingDirectory });
...
Utils.POST_BUILD_PUBLISH_DISABLE = 'disable-post-build-publish';
