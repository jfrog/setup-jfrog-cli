...
class Utils {
    ...
    static getUsageBadge() {
        ...
        const SOURCE_PARAM_KEY = 's';
        const SOURCE_PARAM_VALUE = '1';
        // Metric query parameter indicating the metric type
        const METRIC_PARAM_KEY = 'm';
        const METRIC_PARAM_VALUE = '1';
        const JOB_ID_PARAM_KEY = 'job_id';
        const RUN_ID_PARAM_KEY = 'run_id';
        const GIT_REPO_PARAM_KEY = 'git_repo';
