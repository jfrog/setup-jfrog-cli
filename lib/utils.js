...
class Utils {
     ...
     */
    static generateCliSummary() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Utils.setAsJobSummary();
        });
    }
    static setAsJobSummary() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const fileNames = ['upload-data.md', 'build-publish.md', 'security.md'];
                let fileContent = '';
                fileContent += '<p >\n' +
                    '  <h1> \n' +
                    ...
                    '</p>  ';
                // load each section
                let homedir = Utils.getCliJobSummaryPathByOs();
