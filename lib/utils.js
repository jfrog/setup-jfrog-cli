...
class Utils {
    ...
    static getSeparateEnvConfigArgs(jfrogCredentials) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!oidcProviderName && !!oidcTokenId) {
                accessToken = yield this.exchangeOIDCToken(oidcProviderName, oidcTokenId, url, oidcAudience);
            }
     ...
     * @private
     */
    static exchangeOIDCToken(oidcProviderName, oidcTokenId, url, oidcAudience) {
        return __awaiter(this, void 0, void 0, function* () {
            let output;
            try {
