...
class Utils {
    ...
    static getAndAddCliToPath(jfrogCredentials) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (version == Utils.LATEST_RELEASE_VERSION) {
                version = yield Utils.getActualVersion(downloadedExecutable);
            }
            yield this.cacheAndAddPath(downloadedExecutable, version, jfFileName);
            yield this.cacheAndAddPath(downloadedExecutable, version, jfrogFileName);
        });
    }
    /**
    ...
    static addCachedCliToPath() {
        ...
        if (version === Utils.LATEST_CLI_VERSION) {
            version = Utils.LATEST_RELEASE_VERSION;
            let versions = toolCache.findAllVersions(Utils.getJfExecutableName());
     ...
     */
    static cacheAndAddPath(downloadedExecutable, version, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            let cliDir = yield toolCache.cacheFile(downloadedExecutable, fileName, fileName, version);
            if (!Utils.isWindows()) {
    ...
    static getActualVersion(downloadedExecutable) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                (0, fs_1.chmodSync)(downloadedExecutable, 0o555);
                let output = yield (0, exec_1.getExecOutput)(downloadedExecutable, [`--version`]);
