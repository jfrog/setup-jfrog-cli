...
class Utils {
    ...
    static generateWorkflowSummaryMarkdown() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield fs_1.promises.writeFile(githubStepSummaryFilePath, markdownContent);
    ...
    static readCLIMarkdownSections() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const sectionName of Utils.JOB_SUMMARY_MARKDOWN_SECTIONS_NAMES) {
                fileContent += yield Utils.readSummarySection(outputDir, sectionName, fileContent);
            }
    ...
    static readSummarySection(outputDir, section, fileContent) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const fullPath = path.join(outputDir, section, 'markdown.md');
