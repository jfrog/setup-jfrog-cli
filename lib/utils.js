...
class Utils {
    ...
    static configServerCredentials() {
        ...
        if (url) {
            let configCmd = ['c', 'add', Utils.DEFAULT_SERVER_ID, '--url', url, '--interactive=false'];
            if (user && password) {
    ...
    static configJFrogServers() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let configCommand = Utils.configServerCredentials();
            if (configCommand) {
...
// The value in the download URL to set to get the latest version
Utils.DEFAULT_SERVER_ID = 'default-server-id';
// Inputs
// Version input
