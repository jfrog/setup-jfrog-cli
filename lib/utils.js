...
class Utils {
    ...
    static getJfrogCredentials() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (oidcProviderName) {
                return yield this.getOidcCredentials(jfrogCredentials);
            }
     ...
     */
    static getOidcCredentials(jfrogCredentials) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                core.exportVariable(this.OIDC_CLI_TOKEN_ID_ENV_VAR_NAME, yield core.getIDToken(audience));
            }
            catch (error) {
