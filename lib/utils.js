...
class Utils {
    ...
    static cacheAndAddPath(downloadedExecutable, version, fileName) {
        return __awaiter(this, void 0, void 0, function* () {
            let cliCacheDir = yield toolCache.cacheFile(downloadedExecutable, fileName, fileName, version);
            core.addPath(cliCacheDir);
            const cliCachePath = (0, path_1.join)(cliCacheDir, fileName);
            if (!Utils.isWindows()) {
                (0, fs_1.chmodSync)(cliCachePath, 0o555);
            }
