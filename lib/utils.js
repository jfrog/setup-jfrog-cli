...
class Utils {
    ...
    static getAccessTokenFromJWT(jfrogCredentials, jsonWebToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const provider_name = core.getInput(Utils.OIDC_INTEGRATION_PROVIDER_NAME, { required: true });
            ...
            try {
                ...
                console.log(`ERAN CHECK: response string: ${yield response.readBody()}`); // TODO del
                const responseJson = JSON.parse(yield response.readBody());
...
Utils.OIDC_INTEGRATION_PROVIDER_NAME = 'provider_name';
