...
class Utils {
    ...
    static generateJobSummary() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let sourceFilePath = Utils.getCliJobSummaryPathByOs();
                console.log(`Reading job summary from ${sourceFilePath} and writing it to ${endFilePath}`);
                // Read the content of the source file
                const fileContent = yield fs_1.promises.readFile(sourceFilePath, 'utf-8');
    ...
    static prepareGitHubJobSummaries() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let sourceFilePath = Utils.getCliJobSummaryPathByOs();
                yield fs_1.promises.access(sourceFilePath);
                yield fs_1.promises.unlink(sourceFilePath);
    ...
    static getCliJobSummaryPathByOs() {
        switch (process.env.RUNNER_OS) {
            case "Windows":
                return (0, path_1.join)(process.env.USERPROFILE || '', ".jfrog", "jfrog-github-summary", "summary.md");
            case "Linux":
            case "macOS":
                return (0, path_1.join)(process.env.HOME || '', ".jfrog", "jfrog-github-summary", "summary.md");
            default:
                return "";
        }
    }
