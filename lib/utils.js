...
class Utils {
    ...
    static readCommandSummaryMarkdown() {
        return __awaiter(this, void 0, void 0, function* () {
            let markdownContent = '';
            markdownContent = yield Utils.readMarkdownContent();
...
Utils.JFROG_CLI_PATH_STATE = 'JFROG_CLI_PATH_STATE';
...
Utils.MARKDOWN_HEADER_PNG_URL = 'https://raw.githubusercontent.com/EyalDelarea/setup-jfrog-cli/improve_summary_ui/images/summary_header.png';
