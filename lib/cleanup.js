        ...
        try {
            ...
            if (!core.getBooleanInput(utils_1.Utils.AUTO_BUILD_PUBLISH_DISABLE)) {
                if (yield hasUnpublishedModules()) {
                    yield utils_1.Utils.runCliAndGetOutput(['rt', buildPublishCmd]);
                }
            }
        }
        catch (error) {
...
function hasUnpublishedModules() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const responseStr = yield utils_1.Utils.runCliAndGetOutput(['rt', buildPublishCmd, '--dry-run'], { silent: true });
