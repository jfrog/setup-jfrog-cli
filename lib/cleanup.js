...
const jobsummary_utils_1 = require("./jobsummary-utils");
function cleanup() {
...
function buildInfoPostTasks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const disableJobSummary = core.getBooleanInput(utils_1.Utils.JOB_SUMMARY_DISABLE) || !jobsummary_utils_1.jobSummaryUtils.isJobSummarySupported();
...
function hasUnpublishedModules(workingDirectory) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const origValue = process.env[jobsummary_utils_1.jobSummaryUtils.JFROG_CLI_COMMAND_SUMMARY_OUTPUT_DIR_ENV];
        try {
            core.startGroup('Check for unpublished modules');
            // Avoid saving a command summary for this dry-run command
            core.exportVariable(jobsummary_utils_1.jobSummaryUtils.JFROG_CLI_COMMAND_SUMMARY_OUTPUT_DIR_ENV, '');
            ...
            core.exportVariable(jobsummary_utils_1.jobSummaryUtils.JFROG_CLI_COMMAND_SUMMARY_OUTPUT_DIR_ENV, origValue);
            core.endGroup();
        }
    });
}
...
function generateJobSummary() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield jobsummary_utils_1.jobSummaryUtils.setMarkdownAsJobSummary();
            yield jobsummary_utils_1.jobSummaryUtils.populateCodeScanningTab();
            // Clear files
            yield jobsummary_utils_1.jobSummaryUtils.clearCommandSummaryDir();
        }
        catch (error) {
