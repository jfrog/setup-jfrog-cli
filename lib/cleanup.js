...
function publishBuildInfoIfNeeded() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let response = yield utils_1.Utils.runCliAndGetOutput(['rt', 'bp', '--dry-run']);
        console.log('Response:', response);
        console.log(hasUnpublishedModules(response));
        yield utils_1.Utils.runCli(['npm-config', '--repo-resolve', 'npm-virtual']);
        yield utils_1.Utils.runCli(['npm', 'i']);
        response = yield utils_1.Utils.runCliAndGetOutput(['rt', 'bp', '--dry-run']);
        console.log('Response:', response);
        console.log(hasUnpublishedModules(response));
    });
}
