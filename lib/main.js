...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            console.log("ERAN CHECK: ####################### 34 #######################"); // TODO del
            let jfrogCredentials = yield utils_1.Utils.getJfrogCredentials(); //TODO make it return a struct with: username, password and access_token, jfrog url
